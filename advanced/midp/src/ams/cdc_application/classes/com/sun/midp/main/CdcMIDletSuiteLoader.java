...
public class CdcMIDletSuiteLoader extends AbstractMIDletSuiteLoader
    ...
    protected void initSuiteEnvironment() {
        ...
        if (midletClassName.equals("internal")) {
            Properties props = getJarProps(MIDPLauncher.getMidletSuitePath());
            String name = props.getProperty("MIDlet-1");
            midletClassName = new MIDletInfo(name).classname;
        }
    }
     ...
     *
     * @param filePaths full path of the JAR
     *
     * @return JAR properties
     */
    private Properties getJarProps(String[] filePaths) {
        String jarPath = null;
