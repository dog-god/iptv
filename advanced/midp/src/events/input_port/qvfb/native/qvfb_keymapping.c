...
KeyMapping qvfb_keys[] = {
    ...
    {KEYMAP_KEY_LEFT,          0x0012},    /* LEFT key */
    {KEYMAP_KEY_UP,            0x0013},    /* UP key */
    {KEYMAP_KEY_RIGHT,         0x0014},    /* RIGHT key */
    {KEYMAP_KEY_DOWN,          0x0015},    /* DOWN key */
    ...
    {KEYMAP_KEY_SELECT,        0x0004},    /* ENTER key */
    {KEYMAP_KEY_BACKSPACE,     0x0003},    /* BACKSPACE key */
